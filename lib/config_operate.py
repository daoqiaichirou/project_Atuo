...
if __name__ == '__main__':
    ...
    host = conf.get_config('mysql_conf', 'host')
    port = int(conf.get_config('mysql_conf', 'port'))
    user = conf.get_config('mysql_conf', 'username')
    passwd = conf.get_config('mysql_conf', 'password')
    print(host)
    print(port)
    print(user)
    print(passwd)
